...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new dev.ssdd.encrypto_flutter.EncryptoFlutterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin encrypto_flutter, dev.ssdd.encrypto_flutter.EncryptoFlutterPlugin", e);
    }
    try {
