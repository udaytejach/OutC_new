...
//
//     final flightsList = flightsListFromJson(jsonString);

import 'dart:convert';

FlightsList flightsListFromJson(String str) =>
    FlightsList.fromJson(json.decode(str));

String flightsListToJson(FlightsList data) => json.encode(data.toJson());
...
class FlightsList {
  ...
  factory FlightsList.fromJson(Map<String, dynamic> json) => FlightsList(
...
class FareFamily {
  ...
  factory FareFamily.fromJson(Map<String, dynamic> json) => FareFamily(
        fareId: json["fareId"],
        // purchaseType: purchaseTypeValues.map[json["purchaseType"]]!,
        // fareType: fareTypeValues.map[json["fareType"]]!,
        // coupanType: coupanTypeValues.map[json["coupanType"]]!,
  ...
  Map<String, dynamic> toJson() => {
        "fareId": fareId,
        // "purchaseType": purchaseTypeValues.reverse[purchaseType],
        // "fareType": fareTypeValues.reverse[fareType],
        // "coupanType": coupanTypeValues.reverse[coupanType],
...
class Baggage {
  ...
  factory Baggage.fromJson(Map<String, dynamic> json) => Baggage(
        ...
        baggageInfo: json["baggageInfo"].toString(),
        cityPair: json["cityPair"].toString(),
        cabinBaggageInfo: json["cabinBaggageInfo"].toString(),
      );
...
class FlightSegment {
  ...
  factory FlightSegment.fromJson(Map<String, dynamic> json) => FlightSegment(
        ...
        // operatingAirline: lineValues.map[json["operatingAirline"]]!,
        // equipmentType: json["equipmentType"],
        // departureTerminal: json["departureTerminal"],
        // arrivalTerminal: json["arrivalTerminal"],
        // marketingAirline: lineValues.map[json["marketingAirline"]]!,
        ...
        //     ? []
        //     : List<dynamic>.from(json["ssrInfo"]!.map((x) => x)),
      );
