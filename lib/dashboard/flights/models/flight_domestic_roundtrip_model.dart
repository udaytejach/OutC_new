...
//
//     final flightDomesticRoundtripModel = flightDomesticRoundtripModelFromJson(jsonString);

import 'dart:convert';

FlightDomesticRoundtripModel flightDomesticRoundtripModelFromJson(String str) =>
    FlightDomesticRoundtripModel.fromJson(json.decode(str));

String flightDomesticRoundtripModelToJson(FlightDomesticRoundtripModel data) =>
    json.encode(data.toJson());

class FlightDomesticRoundtripModel {
  final int? statusCode;
  final Data? data;
  final String? message;

  FlightDomesticRoundtripModel({
    this.statusCode,
    this.data,
    this.message,
  });

  factory FlightDomesticRoundtripModel.fromJson(Map<String, dynamic> json) =>
      FlightDomesticRoundtripModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        flightDetails: json["flightDetails"] == null
            ...
            : List<FlightDetail>.from(
                json["flightDetails"]!.map((x) => FlightDetail.fromJson(x))),
        ibFlightDetails: json["ibFlightDetails"] == null ? [] : List<FlightDetail>.from(json["ibFlightDetails"]!.map((x) => FlightDetail.fromJson(x))),
        ...
        // ibFilterObj: json["ibFilterObj"] == null ? null : Obj.fromJson(json["ibFilterObj"]),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "ibFlightDetails": ibFlightDetails == null ? [] : List<dynamic>.from(ibFlightDetails!.map((x) => x.toJson())),
        ...
        // "ibFilterObj": ibFilterObj?.toJson(),
      };
}
...
class FlightDetail {
  ...
  // final ResultFareType? resultFareType;
  // final SupplierKey? supplierKey;
...
// class MiniRule {
//     final JourneyPoints? journeyPoints;
//     final TypeEnum? type;
//     final dynamic from;
//     final dynamic to;
//     final dynamic unit;
