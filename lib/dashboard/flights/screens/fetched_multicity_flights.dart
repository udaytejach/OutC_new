...
class FetchedMulticityFlights extends StatefulWidget {
  ...
  @override
  State<FetchedMulticityFlights> createState() =>
      _FetchedMulticityFlightsState();
}

class _FetchedMulticityFlightsState extends State<FetchedMulticityFlights> {
                ...
                : Expanded(
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          double amt = dataFlightDetails![index]
                                  .fareFamilies!
                                  .fareFamilies![0]
                                  .adultPublishFare! *
                              double.parse(
                                                          ...
                                                          children: [
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                  "${dataFlightDetails![index].flightDetails![0].origin} - ${dataFlightDetails![index].flightDetails![0].destination}",
                                                                  style:
                                                                      TextStyle(
                                                                    fontSize:
                                                                        14.0,
                                                                ...
                                                                Text(
                                                                  "${dataFlightDetails![index].flightDetails![0].airLineName} - ${dataFlightDetails![index].flightDetails![0].airLine}",
                                                                  style:
                                                                      TextStyle(
                                                                    fontSize:
                                                                        14.0,
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                  dataFlightDetails![index]
                                                                          ...
                                                                          .isEmpty
                                                                      ? "7 kgs Cabin Baggage"
                                                                      : "${dataFlightDetails![index].flightDetails![0].flightSegments![0].cabinBaggage} Cabin Baggage",
                                                                  style:
                                                                      TextStyle(
                                                                    fontSize:
                                                                        14.0,
