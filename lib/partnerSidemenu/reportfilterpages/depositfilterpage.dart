...
import 'package:outc/partnerSidemenu/reportlistpages/depositreports.dart';
...
class DepositFilterPage extends StatefulWidget {
  const DepositFilterPage({super.key});

  @override
  State<DepositFilterPage> createState() => _DepositFilterPageState();
}

class _DepositFilterPageState extends State<DepositFilterPage> {
  String selectedOptions = 'Last One Hour';
  var optionTypes = ['Last One Hour', 'Yesterday', 'Last Week', 'Custom Dates'];
  String selectedStatus = 'Pending';
  var statusTypes = ['Pending', 'Accepted', 'Rejected'];
  String status = "1";
  ...
  Widget build(BuildContext context) {
    var depositreportsProvider = context.watch<DepositReportsProvider>();
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    depositreportsProvider.clearReportsDetails();
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (BuildContext context) {
                          return const DepositReportsPage();
                        },
                      ),
                    );
