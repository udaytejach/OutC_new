...
import 'package:outc/partnerSidemenu/reportlistpages/statementreports.dart';
...
class StatementFilterPage extends StatefulWidget {
  const StatementFilterPage({super.key});

  @override
  State<StatementFilterPage> createState() => _StatementFilterPageState();
}

class _StatementFilterPageState extends State<StatementFilterPage> {
  ...
  Widget build(BuildContext context) {
    var statementreportsProvider = context.watch<StatementReportsProvider>();
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    statementreportsProvider.clearReportsDetails();
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (BuildContext context) {
                          return const StatementReportsPage();
                        },
                      ),
                    );
