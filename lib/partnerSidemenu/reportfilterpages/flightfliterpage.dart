...
import 'package:outc/partnerSidemenu/reportlistpages/flightreports.dart';
...
class FlightFilterPage extends StatefulWidget {
  const FlightFilterPage({super.key});
...
class _FlightFilterPageState extends State<FlightFilterPage> {
  ...
  Widget build(BuildContext context) {
    var flightreportsProvider = context.watch<FlightReportsProvider>();
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    flightreportsProvider.clearReportsDetails();
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (BuildContext context) {
                          return const FlightrepPage();
                        },
                      ),
                    );
