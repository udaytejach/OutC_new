...
import 'package:outc/partnerSidemenu/reportlistpages/carreports.dart';
...
class _CarFilterPageState extends State<CarFilterPage> {
  ...
  Widget build(BuildContext context) {
    var carreportsProvider = context.watch<CarReportsProvider>();
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    carreportsProvider.clearReportsDetails();
